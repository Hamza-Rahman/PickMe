  ...
  <head>
    ...
    <link href="../css/bootstrap.css" rel="stylesheet">
        ...
        <script type="text/javascript">
            ...
            function sureToCheck(id) {

                 var hieridvalue = id;

                  $.post('check.php', {hierid:hieridvalue}, function(data){  

                  alert(data);                 
                  
                   //if(confirm(data) == true) sureToApprove(id); else window.location.href = 'index.php';
                   sureToApprove(id);
              ...
              <tbody>
                <tr>
                    ...
                    <td><?php echo $row['status'] == 0 ? "Pending" : "Approved"; ?></td>
                     ...
                     <td><?php if ($row['status'] != 1): ?><a href="javascript:sureToCheck(<?php echo $row['hire_id']; ?>)" class="space" >Approve</a><a href="javascript:sureToDelete(<?php echo $row['hire_id']; ?>)" > Delete</a></td>
                        <?php else: ?>
                      <a href="javascript:sureToCancle(<?php echo $row['hire_id']; ?>)" class="space"> Cancel</a>
                        <?php endif; ?></td>
